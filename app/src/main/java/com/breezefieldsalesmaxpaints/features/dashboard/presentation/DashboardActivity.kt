package com.breezefieldsalesmaxpaints.features.dashboard.presentation
...
import com.breezefieldsalesmaxpaints.*
import com.breezefieldsalesmaxpaints.R
import com.breezefieldsalesmaxpaints.app.*
import com.breezefieldsalesmaxpaints.app.NewFileUtils.browseDocuments
import com.breezefieldsalesmaxpaints.app.NewFileUtils.browsePDFDocuments
import com.breezefieldsalesmaxpaints.app.NewFileUtils.getExtension
import com.breezefieldsalesmaxpaints.app.domain.*
import com.breezefieldsalesmaxpaints.app.types.DashboardType
import com.breezefieldsalesmaxpaints.app.types.FragType
import com.breezefieldsalesmaxpaints.app.types.TopBarConfig
import com.breezefieldsalesmaxpaints.app.uiaction.DisplayAlert
import com.breezefieldsalesmaxpaints.app.utils.*
import com.breezefieldsalesmaxpaints.app.utils.AppUtils.Companion.isProfile
import com.breezefieldsalesmaxpaints.base.BaseResponse
import com.breezefieldsalesmaxpaints.base.presentation.BaseActivity
import com.breezefieldsalesmaxpaints.base.presentation.BaseFragment
import com.breezefieldsalesmaxpaints.features.NewQuotation.*
import com.breezefieldsalesmaxpaints.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldsalesmaxpaints.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldsalesmaxpaints.features.SearchLocation.SearchLocationFragment
import com.breezefieldsalesmaxpaints.features.SearchLocation.locationInfoModel
import com.breezefieldsalesmaxpaints.features.TA.ViewAllTAListFragment
import com.breezefieldsalesmaxpaints.features.achievement.AchievementFragment
import com.breezefieldsalesmaxpaints.features.activities.presentation.*
import com.breezefieldsalesmaxpaints.features.addAttendence.*
import com.breezefieldsalesmaxpaints.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldsalesmaxpaints.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldsalesmaxpaints.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldsalesmaxpaints.features.addAttendence.model.GetReportToResponse
import com.breezefieldsalesmaxpaints.features.addAttendence.model.Leave_list_Response
import com.breezefieldsalesmaxpaints.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldsalesmaxpaints.features.addshop.presentation.AddShopFragment
import com.breezefieldsalesmaxpaints.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldsalesmaxpaints.features.addshop.presentation.ScanImageFragment
import com.breezefieldsalesmaxpaints.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldsalesmaxpaints.features.alarm.model.AlarmData
import com.breezefieldsalesmaxpaints.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldsalesmaxpaints.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldsalesmaxpaints.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldsalesmaxpaints.features.alarm.presetation.VisitReportFragment
import com.breezefieldsalesmaxpaints.features.attendance.AttendanceFragment
import com.breezefieldsalesmaxpaints.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldsalesmaxpaints.features.attendance.model.AttendanceRequest
import com.breezefieldsalesmaxpaints.features.attendance.model.AttendanceResponse
import com.breezefieldsalesmaxpaints.features.averageshop.presentation.AverageShopFragment
import com.breezefieldsalesmaxpaints.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldsalesmaxpaints.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldsalesmaxpaints.features.beatCustom.TeamBeatListFragment
import com.breezefieldsalesmaxpaints.features.billing.presentation.AddBillingFragment
import com.breezefieldsalesmaxpaints.features.billing.presentation.BillingDetailsFragment
import com.breezefieldsalesmaxpaints.features.billing.presentation.BillingListFragment
import com.breezefieldsalesmaxpaints.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldsalesmaxpaints.features.chat.model.ChatListDataModel
import com.breezefieldsalesmaxpaints.features.chat.model.ChatUserDataModel
import com.breezefieldsalesmaxpaints.features.chat.model.GroupUserDataModel
import com.breezefieldsalesmaxpaints.features.chat.presentation.*
import com.breezefieldsalesmaxpaints.features.chatbot.presentation.ChatBotFragment
import com.breezefieldsalesmaxpaints.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldsalesmaxpaints.features.chatbot.presentation.ReportsFragment
import com.breezefieldsalesmaxpaints.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldsalesmaxpaints.features.commondialog.presentation.CommonDialog
import com.breezefieldsalesmaxpaints.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldsalesmaxpaints.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldsalesmaxpaints.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldsalesmaxpaints.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldsalesmaxpaints.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldsalesmaxpaints.features.contacts.ActivityDtlsFrag
import com.breezefieldsalesmaxpaints.features.contacts.ContactDtls
import com.breezefieldsalesmaxpaints.features.contacts.ContactGr
import com.breezefieldsalesmaxpaints.features.contacts.ContactsAddFrag
import com.breezefieldsalesmaxpaints.features.contacts.ContactsFrag
import com.breezefieldsalesmaxpaints.features.contacts.SchedulerViewFrag
import com.breezefieldsalesmaxpaints.features.contacts.SchedulerAddFormFrag
import com.breezefieldsalesmaxpaints.features.contacts.TemplateAddFrag
import com.breezefieldsalesmaxpaints.features.contacts.TemplateViewFrag
import com.breezefieldsalesmaxpaints.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldsalesmaxpaints.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldsalesmaxpaints.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldsalesmaxpaints.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldsalesmaxpaints.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldsalesmaxpaints.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldsalesmaxpaints.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldsalesmaxpaints.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldsalesmaxpaints.features.document.presentation.DocumentListFragment
import com.breezefieldsalesmaxpaints.features.document.presentation.DocumentTypeListFragment
import com.breezefieldsalesmaxpaints.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldsalesmaxpaints.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldsalesmaxpaints.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldsalesmaxpaints.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldsalesmaxpaints.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldsalesmaxpaints.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldsalesmaxpaints.features.home.presentation.HomeFragment
import com.breezefieldsalesmaxpaints.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldsalesmaxpaints.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldsalesmaxpaints.features.know_your_state.KnowYourStateFragment
import com.breezefieldsalesmaxpaints.features.lead.LeadFrag
import com.breezefieldsalesmaxpaints.features.lead.ViewLeadFrag
import com.breezefieldsalesmaxpaints.features.leaderboard.LeaderBoardFrag
import com.breezefieldsalesmaxpaints.features.leaveapplynew.LeaveHome
import com.breezefieldsalesmaxpaints.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldsalesmaxpaints.features.localshops.LocalShopListFragment
import com.breezefieldsalesmaxpaints.features.localshops.LocalShopListMapFragment
import com.breezefieldsalesmaxpaints.features.localshops.NearByShopsMapFragment
import com.breezefieldsalesmaxpaints.features.location.*
import com.breezefieldsalesmaxpaints.features.location.api.LocationRepoProvider
import com.breezefieldsalesmaxpaints.features.location.model.*
import com.breezefieldsalesmaxpaints.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldsalesmaxpaints.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldsalesmaxpaints.features.login.ShopFeedbackEntity
import com.breezefieldsalesmaxpaints.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldsalesmaxpaints.features.login.presentation.LoginActivity
import com.breezefieldsalesmaxpaints.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldsalesmaxpaints.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldsalesmaxpaints.features.marketAssist.MarketAssistTabFrag
import com.breezefieldsalesmaxpaints.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldsalesmaxpaints.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldsalesmaxpaints.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldsalesmaxpaints.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldsalesmaxpaints.features.member.MapViewForTeamFrag
import com.breezefieldsalesmaxpaints.features.member.model.TeamLocDataModel
import com.breezefieldsalesmaxpaints.features.member.model.TeamShopListDataModel
import com.breezefieldsalesmaxpaints.features.member.presentation.*
import com.breezefieldsalesmaxpaints.features.menuBeat.MenuBeatFrag
import com.breezefieldsalesmaxpaints.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldsalesmaxpaints.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldsalesmaxpaints.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldsalesmaxpaints.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldsalesmaxpaints.features.myjobs.model.CustomerDataModel
import com.breezefieldsalesmaxpaints.features.myjobs.presentation.*
import com.breezefieldsalesmaxpaints.features.myorder.presentation.MyOrderListFragment
import com.breezefieldsalesmaxpaints.features.myprofile.presentation.MyProfileFragment
import com.breezefieldsalesmaxpaints.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezefieldsalesmaxpaints.features.nearbyshops.model.ShopData
import com.breezefieldsalesmaxpaints.features.nearbyshops.model.ShopListResponse
import com.breezefieldsalesmaxpaints.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldsalesmaxpaints.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldsalesmaxpaints.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldsalesmaxpaints.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldsalesmaxpaints.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldsalesmaxpaints.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldsalesmaxpaints.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldsalesmaxpaints.features.newcollection.CollectionShopListFragment
import com.breezefieldsalesmaxpaints.features.newcollection.NewCollectionListFragment
import com.breezefieldsalesmaxpaints.features.newcollectionreport.*
import com.breezefieldsalesmaxpaints.features.notification.NotificationFragment
import com.breezefieldsalesmaxpaints.features.orderITC.CartListFrag
import com.breezefieldsalesmaxpaints.features.orderITC.OrderListFrag
import com.breezefieldsalesmaxpaints.features.orderITC.ProductListFrag
import com.breezefieldsalesmaxpaints.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldsalesmaxpaints.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldsalesmaxpaints.features.orderITC.ViewOrdDtls
import com.breezefieldsalesmaxpaints.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldsalesmaxpaints.features.orderList.NewOrderListFragment
import com.breezefieldsalesmaxpaints.features.orderList.OrderListFragment
import com.breezefieldsalesmaxpaints.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldsalesmaxpaints.features.orderhistory.ActivityMapFragment
import com.breezefieldsalesmaxpaints.features.orderhistory.OrderhistoryFragment
import com.breezefieldsalesmaxpaints.features.orderhistory.TimeLineFragment
import com.breezefieldsalesmaxpaints.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefieldsalesmaxpaints.features.orderhistory.model.LocationData
import com.breezefieldsalesmaxpaints.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldsalesmaxpaints.features.performance.GpsStatusFragment
import com.breezefieldsalesmaxpaints.features.performance.PerformanceFragment
import com.breezefieldsalesmaxpaints.features.performance.api.UpdateGpsStatusRepoProvider
...
import com.breezefieldsalesmaxpaints.features.performanceAPP.PerformanceAppFragment
import com.breezefieldsalesmaxpaints.features.performanceAPP.allPerformanceFrag
import com.breezefieldsalesmaxpaints.features.permissionList.ViewPermissionFragment
import com.breezefieldsalesmaxpaints.features.photoReg.*
import com.breezefieldsalesmaxpaints.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldsalesmaxpaints.features.quotation.presentation.*
import com.breezefieldsalesmaxpaints.features.reimbursement.presentation.*
import com.breezefieldsalesmaxpaints.features.report.presentation.*
import com.breezefieldsalesmaxpaints.features.returnsOrder.*
import com.breezefieldsalesmaxpaints.features.settings.presentation.SettingsFragment
import com.breezefieldsalesmaxpaints.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldsalesmaxpaints.features.shopdetail.presentation.*
import com.breezefieldsalesmaxpaints.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesmaxpaints.features.stock.StockDetailsFragment
import com.breezefieldsalesmaxpaints.features.stock.StockListFragment
import com.breezefieldsalesmaxpaints.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldsalesmaxpaints.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldsalesmaxpaints.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldsalesmaxpaints.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldsalesmaxpaints.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldsalesmaxpaints.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldsalesmaxpaints.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldsalesmaxpaints.features.survey.SurveyFrag
import com.breezefieldsalesmaxpaints.features.survey.SurveyViewDtlsFrag
import com.breezefieldsalesmaxpaints.features.survey.SurveyViewFrag
import com.breezefieldsalesmaxpaints.features.task.presentation.AddTaskFragment
import com.breezefieldsalesmaxpaints.features.task.presentation.CalenderTaskFragment
import com.breezefieldsalesmaxpaints.features.task.presentation.EditTaskFragment
import com.breezefieldsalesmaxpaints.features.task.presentation.TaskListFragment
import com.breezefieldsalesmaxpaints.features.taskManagement.TaskManagementFrag
import com.breezefieldsalesmaxpaints.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldsalesmaxpaints.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldsalesmaxpaints.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldsalesmaxpaints.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.CartFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.ViewCartFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldsalesmaxpaints.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldsalesmaxpaints.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldsalesmaxpaints.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldsalesmaxpaints.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldsalesmaxpaints.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldsalesmaxpaints.features.viewPPDDStock.ViewStockFragment
import com.breezefieldsalesmaxpaints.features.weather.presentation.WeatherFragment
import com.breezefieldsalesmaxpaints.mappackage.MapActivity
import com.breezefieldsalesmaxpaints.mappackage.MapActivityWithoutPath
import com.breezefieldsalesmaxpaints.mappackage.SendBrod
import com.breezefieldsalesmaxpaints.widgets.AppCustomEditText
import com.breezefieldsalesmaxpaints.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldsalesmaxpaintslogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmaxpaintslogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefieldsalesmaxpaints/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmaxpaintslogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmaxpaintslogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmaxpaintslogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmaxpaintslogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
