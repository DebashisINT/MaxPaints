package com.breezefieldsalesmaxpaints.features.reimbursement.presentation
...
import com.breezefieldsalesmaxpaints.app.utils.AppUtils.Companion.convertFromRightToReverseFormatWithTime
import com.breezefieldsalesmaxpaints.app.utils.AppUtils.Companion.getFormattedDateForApi
import com.breezefieldsalesmaxpaints.app.utils.AppUtils.Companion.hideSoftKeyboard
import com.breezefieldsalesmaxpaints.app.utils.CustomTextWatcher
import com.breezefieldsalesmaxpaints.app.utils.PermissionUtils
import com.breezefieldsalesmaxpaints.app.utils.ProcessImageUtils_v1
...
import com.breezefieldsalesmaxpaints.features.reimbursement.api.ReimbursementConfigRepoProvider
import com.breezefieldsalesmaxpaints.features.reimbursement.api.applyapi.ApplyReimbursementRepoProvider
import com.breezefieldsalesmaxpaints.features.reimbursement.api.configfetchapi.ReimbursementConfigFetchRepoProvider
import com.breezefieldsalesmaxpaints.features.reimbursement.api.reimbursement_list_api.ReimbursementListRepoProvider
import com.breezefieldsalesmaxpaints.features.reimbursement.api.reimbursementshopapi.ReimbursementShopRepoProvider
import com.breezefieldsalesmaxpaints.features.reimbursement.model.*
import com.breezefieldsalesmaxpaints.features.reimbursement.model.reimbursement_shop.ReimbursementShopDataModel
import com.breezefieldsalesmaxpaints.features.reimbursement.model.reimbursement_shop.ReimbursementShopResponseModel
import com.breezefieldsalesmaxpaints.features.reimbursement.model.reimbursementlist.ReimbursementListDataModel
import com.breezefieldsalesmaxpaints.features.reimbursement.model.reimbursementlist.ReimbursementListDetailsModel
import com.breezefieldsalesmaxpaints.features.reimbursement.model.reimbursementlist.ReimbursementListResponseModel
...
class ReimbursementFragment : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    private fun initView(view: View) {
        ...
        //attachbreezefieldsalesmaxpaintsData()
...
//                            XLog.d("ReimbursementConfigApiResponse ERROR: " + error.localizedMessage)
    ...
    private fun attachbreezefieldsalesmaxpaintsData() {
