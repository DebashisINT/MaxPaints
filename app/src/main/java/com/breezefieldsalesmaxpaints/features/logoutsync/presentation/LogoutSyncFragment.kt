package com.breezefieldsalesmaxpaints.features.logoutsync.presentation
...
import com.breezefieldsalesmaxpaints.app.utils.Toaster
...
import com.breezefieldsalesmaxpaints.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldsalesmaxpaints.features.billing.api.AddBillingRepoProvider
import com.breezefieldsalesmaxpaints.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldsalesmaxpaints.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldsalesmaxpaints.features.document.model.AddEditDocumentInputParams
import com.breezefieldsalesmaxpaints.features.document.model.DocumentAttachmentModel
...
import com.breezefieldsalesmaxpaints.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldsalesmaxpaints.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldsalesmaxpaints.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldsalesmaxpaints.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldsalesmaxpaints.features.orderhistory.model.*
...
import com.breezefieldsalesmaxpaints.features.quotation.model.AddQuotInputModel
import com.breezefieldsalesmaxpaints.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldsalesmaxpaints.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldsalesmaxpaints.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldsalesmaxpaints.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldsalesmaxpaints.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldsalesmaxpaints.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldsalesmaxpaints.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldsalesmaxpaints.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldsalesmaxpaints.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldsalesmaxpaints.mappackage.SendBrod
import com.breezefieldsalesmaxpaints.widgets.AppCustomTextView
import com.breezefieldsalesmaxpaints.MonitorService
import com.breezefieldsalesmaxpaints.MySingleton
...
import com.breezefieldsalesmaxpaints.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldsalesmaxpaints.features.login.model.GetConcurrentUserResponse
import com.breezefieldsalesmaxpaints.features.login.model.WhatsappApiData
import com.breezefieldsalesmaxpaints.features.orderITC.SyncOrd
import com.breezefieldsalesmaxpaints.features.orderITC.SyncOrdProductL
import com.breezefieldsalesmaxpaints.features.performance.model.Gps_status_list
import com.breezefieldsalesmaxpaints.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldsalesmaxpaints.features.returnsOrder.ReturnProductList
import com.breezefieldsalesmaxpaints.features.returnsOrder.ReturnRequest
import com.breezefieldsalesmaxpaints.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmaxpaintslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmaxpaintslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldsalesmaxpaintslogsample/log.zip").path);
